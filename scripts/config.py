...
DRIVE_INCOMING_FOLDER_ID = os.environ["DRIVE_INCOMING_FOLDER_ID"]
DRIVE_PROCESSED_FOLDER_ID = os.environ["DRIVE_PROCESSED_FOLDER_ID"]
DRIVE_FAILED_FOLDER_ID = os.environ.get("DRIVE_FAILED_FOLDER_ID", "")
...
LOG_SHEET_TAB = os.environ.get("LOG_SHEET_TAB", "Log")

# --- Transcription (Groq Whisper-large-v3 or OpenAI Whisper) ---
GROQ_API_KEY = os.environ.get("GROQ_API_KEY", "")
OPENAI_API_KEY = os.environ.get("OPENAI_API_KEY", "") or GROQ_API_KEY
